---
title: Công cụ điều tra thiết bị di động
---
## MobSF
...
Ubuntu/Debian 
- Cài đặt từ terminal: `sudo apt-get install android-tools-adb python3-tk`
Mac
- Cài đặt từ Homebrew: `brew install android-platform-tools`
